<div class="row">
  <div class="col-md-12">
    <h4 class="m-b-lg">
      <strong><?= $item->company_title ?></strong> firma bilgilerini düzenliyorsunuz
    </h4>
  </div><!-- END column -->
  <div class="col-md-12">
    <div class="widget">
      <div class="widget-body">
        <form action="<?= base_url("company_information/update_information/$item->id") ?>" method="post">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control" name="tax_number" type="text"
                       value="<?= isset($form_error) ? set_value("tax_number") : $item->tax_number ?>">
                <?php if (isset($form_error)): ?>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <select class="form-control" name="number_staff_employed">
                    ...
                    <option <?= $item->number_staff_employed == '101-200' ? ' selected' : null  ?>  value="101-200">101-200</option>
